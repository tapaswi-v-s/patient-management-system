...
public class BrowsePage extends javax.swing.JPanel {
     ...
     */
    public BrowsePage(JPanel bottomPanel, PersonController personController) {
    ...
    private void populateFields(){
        ...
        hospitals = personController.getAllHospitals();
        ...
        doctors = personController.getAllDoctors(
                    hospitals.get(drpHospital.getSelectedIndex()),
                    DoctorType.values()[drpDoctorCategory.getSelectedIndex()])
                .stream().toList();
        model2.addAll(doctors.stream().map(doctor -> doctor.getfName()+" "+doctor.getlName()).toList());
        drpDoctor.setModel(model2);
    ...
    private void btnBookActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBookActionPerformed
        Appointment appointment = personController
                .createAppointment(doctors.get(
                        drpDoctor.getSelectedIndex()),
                        txtDate.getDate(),
                        (String) drpTimeSlot.getSelectedItem(),
                        hospitals.get(drpHospital.getSelectedIndex()));
        
        if(appointment != null){
            bottomPanel.add(new RegistrationPage(
                bottomPanel,
                personController,
                appointment));
...
//        }
    ...
    private void drpDoctorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_drpDoctorActionPerformed
        ...
        appointments = personController.getAvailableAppointments(
                doctors.get(drpDoctor.getSelectedIndex()), new Date());
    ...
    private void drpHospitalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_drpHospitalActionPerformed
        DefaultComboBoxModel<String> model = new DefaultComboBoxModel<>();
        doctors = personController.getAllDoctors(
                    hospitals.get(drpHospital.getSelectedIndex()), null)
                .stream().toList();
